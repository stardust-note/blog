  ...
  const posts = [
    {
      ...
      title: 'Game 프로그래밍',
      date: '2025-11-09',
      excerpt: '게임 프로그래밍 종류 알아보기',
      image: '/images/2d/sketch.png',
      tags: ['Game', 'Unity', 'React Native', 'Phaser']
    },
  ]
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h1 className="text-4xl md:text-5xl text-gray-900 mb-4">Game Dev</h1>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {currentPosts.map((post, index) => (
            <motion.article
              ...
              className="group"
            >
              <Link href={`/post/game/${post.slug}`} className="block">
