...
export default function Page() {
  const posts = [
    {
      slug: 'backend-start',
      title: 'Back End 기술 알아보기',
      date: '2025-11-09',
      excerpt: 'Back End 어떤걸 선택할까요?',
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h1 className="text-4xl md:text-5xl text-gray-900 mb-4">Back End</h1>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {currentPosts.map((post, index) => (
            <motion.article
              ...
              className="group"
            >
              <Link href={`/post/backend/${post.slug}`} className="block">
